<?php
// International Institute of Information Technology Bangalore Landing Page - University360
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <script>
        window.PAGE_COURSES = [
            { "value": "CERTIFICATE", "label": "Executive Programme in Generative AI & Agentic AI for Leaders" },
    ...
    <script type="application/ld+json">
    {
      ...
      "@graph": [
        ...
        },
        {
          "@type": "Service",
          "@id": "https://university360.co/iiitb/#counselingservice",
          "name": "Educational Counseling for IIIT Bangalore Online Courses",
          "provider": {
            "@id": "https://university360.co/#organization"
          },
          ...
          "description": "Counseling and career guidance for working professionals and students exploring IIIT Bangalore online courses in Data Science, AI, Machine Learning and leadership programs.",
          "offers": {
            "@type": "Offer",
            "price": "0.00",
            "priceCurrency": "INR",
        ...
        },
        {
          ...
          "name": "Executive Programme in Generative AI & Agentic AI for Leaders - IIIT Bangalore",
...
<body>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 col-md-12">
                    <div class="amity-banner-content-wrap">
                        ...
                        <div class="d-none d-lg-block">
                            <button class="amity-download-brochure-btn"
                                onclick="openBrochurePopup('brochures/iiitb_main_brochure.pdf', 'IIITB Programs')">
                    ...
                    <div class="amity-mobile-center-visual">
                        ...
                        <img src="images/new-mobile-v1.webp"
                            alt="International Institute of Information Technology Bangalore Student"
    ...
    <section class="amity-programmes-section" id="programmes">
        <div class="container">
            <h2>Programmes &amp; Certifications at IIIT Bangalore</h2>
                ...
                <div class="item">
                    <div class="amity-course-card">
                        ...
                        <img src="images/IIITB Executive Programme in Generative AI for Leaders.webp"
                            alt="Executive Programme in Generative AI & Agentic AI for Leaders" class="amity-course-img">
                        <div class="amity-course-body">
                            <h3>Executive Programme in Generative AI & Agentic AI for Leaders</h3>
                            <h4>Generative AI & Agentic AI for Leaders</h4>
                            ...
                            <div class="amity-course-footer">
                                <button class="get-brochure-btn"
                                    onclick="openBrochurePopup('brochures/IIITB_Executive_Program_in_Generative_AI_for_Leaders.pdf', 'Executive Programme in Generative AI & Agentic AI for Leaders')">
    ...
    <section class="amity-approvals-section" id="approvals">
        <div class="container">
            <h2 class="approvals-main-heading text-center">Accreditation and Approvals of IIIT Bangalore</h2>
            <div class="row mt-4 custom_accreditation_row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="amity-approval-card">
                        <div class="approval-icon"><img src="images/naac-a-iiit.webp" alt="UGC Approved"></div>
                        <h4>NAAC A+</h4>
                        <p>The IIIT Bangalore certificate courses have an A+ grade, which proves that the institute
                            offers quality learning outcomes for professionals.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="amity-approval-card">
                        <div class="approval-icon"><img src="images/ugc-1.webp" alt="UGC-DEB Recognized">
                        </div>
                        <h4>UGC</h4>
                        <p>This recognition confirms the institute's credibility and supports trust in online
                            credentials.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="amity-approval-card">
                        <div class="approval-icon"><img src="images/aicte-1.webp" alt="Globally Accredited"></div>
                        <h4>AICTE</h4>
                        <p>It makes sure that the course is industry-aligned with curriculum standards, technical
                            rigour and value.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="amity-approval-card">
                        <div class="approval-icon"><img src="images/aacsb-new.webp" alt="AICTE Approved"></div>
                        <h4>AACSB</h4>
                        <p>The approval association signals a global business-quality benchmark, strengthening
                            leadership and learning value.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="amity-whychoose-section" id="whychoose">
        <div class="container">
            <h2 class="amity-whychoose-heading">Why Choose University 360 for IIT Programs?</h2>
            <div class="row align-items-center">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        ...
                        <p>Get 100% Free Counseling on International Institute of Information Technology Bangalore DBA
                            Programs</p>
                    </div>
    ...
    <!-- IIITB Mobile Fixed Bottom Action Bar (Mobile View Only) -->
    <div class="amity-mobile-sticky-footer">
        <button type="button" class="amity-mobile-btn-brochure"
            onclick="openBrochurePopup('brochures/iiitb_main_brochure.pdf', '')">
            <span>Get Brochure</span> <i class="fa fa-download"></i>
        </button>
    ...
    <script>
        ...
        function initIIITBCarousel() {
            if (window.jQuery && jQuery.fn && jQuery.fn.owlCarousel) {
                ...
                setTimeout(initIIITBCarousel, 50);
            }
        }

        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', initIIITBCarousel);
        } else {
            initIIITBCarousel();
        }
