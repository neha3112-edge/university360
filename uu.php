<?php
// Uttaranchal University Online Landing Page - University360
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <meta property="og:image:alt" content="Uttaranchal University Online Degree Courses" />
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "Courses",
      "item": "https://university360.co/uu/#program"
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "Approvals",
      "item": "https://university360.co/uu/#approvals"
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "About",
      "item": "https://university360.co/uu/#about"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "FAQ",
      "item": "https://university360.co/uu/#faq"
    }
  ]
}
    </script>
    ...
    <script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "When did Online UU, under which Act, come into existence?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Uttaranchal University online was established under Act No. 11 of 2013 and established in 2013."
      }
    },
    {
      "@type": "Question",
      "name": "Is Uttaranchal University's online fee affordable for students?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, the fee for Uttaranchal University online is affordable for the students and learners. Up to 30% in scholarships are available for online UU early admissions."
      }
    },
    {
      "@type": "Question",
      "name": "Where is the Online UU situated?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Uttaranchal University is located in the capital of Uttarakhand, Dehradun, India."
      }
    },
    {
      "@type": "Question",
      "name": "Is the Online UU degree valid?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, Uttaranchal University's online degree is valid. Uttaranchal University online holds recognition from UGC AND NAAC grade A+."
      }
    },
    {
      "@type": "Question",
      "name": "How can a student get more information about Online UU?",
      "acceptedAnswer": {
        "@type": "Answer",
...
<body>
                ...
                <div class="col-lg-5 col-md-12">
                    <div class="amity-banner-content-wrap">
                        <div class="d-none d-lg-block">
                            <img src="images/uu-online-logo.webp" alt="Uttaranchal University Online"
                                class="amity-banner-logo">
                        </div>

                        <h2 class="amity-sub-lead">Get Guidance From University360 for</h2>
                        <h1 class="amity-main-title">Uttaranchal University Online</h1>
                        <p class="amity-slogan">Learn Today, <br>Lead Tomorrow</p>

                        <div class="amity-pill-box">
                            <span class="amity-pill-badge">Online Degree Courses</span>
                            <p class="amity-pill-courses">
                                <strong>BBA | BCA | BA | MBA | MCA</strong>
                            </p>
                        </div>

                        <div class="d-none d-lg-block">
                            <button class="amity-download-brochure-btn"
                                onclick="openBrochurePopup('brochures/uttaranchal_main_brochure.pdf', 'MBA')">
                    ...
                    <div class="amity-mobile-center-visual">
                        ...
                        <img src="images/new-mobile-v1.webp" alt="Uttaranchal Online Student"
    ...
    <section class="amity-programmes-section" id="programmes">
        <div class="container">
            <h2>Uttaranchal University Online Courses</h2>
                        ...
                        <div class="amity-course-body">
                            ...
                            <div class="amity-course-footer">
                                <button class="get-brochure-btn"
                                    onclick="openBrochurePopup('brochures/uttaranchal_bba.pdf', 'BBA')">
                ...
                <div class="item">
                    <div class="amity-course-card">
                        ...
                        <div class="amity-course-body">
                            ...
                            <div class="amity-course-footer">
                                <button class="get-brochure-btn"
                                    onclick="openBrochurePopup('brochures/uttaranchal_bca.pdf', 'BCA')">
                                    <span>Get Brochure</span> <i class="fa fa-download"></i>
                                </button>
                                <span class="duration-info"><i class="fa fa-hourglass-half"></i> 36 Months</span>
                            </div>
                ...
                <div class="item">
                    <div class="amity-course-card">
                        ...
                        <div class="amity-course-body">
                            ...
                            <div class="amity-course-footer">
                                <button class="get-brochure-btn"
                                    onclick="openBrochurePopup('brochures/uttaranchal_ba.pdf', 'BA')">
                                    <span>Get Brochure</span> <i class="fa fa-download"></i>
                                </button>
                                <span class="duration-info"><i class="fa fa-hourglass-half"></i> 36 Months</span>
                            </div>
                ...
                <div class="item">
                    <div class="amity-course-card">
                        ...
                        <div class="amity-course-body">
                            ...
                            <p>Uttaranchal University Online MBA is a 2-year program designed to build strategic
                                leadership and business acumen. It offers multiple specializations to help working
                                professionals and graduates advance in their careers.</p>
                            <div class="amity-course-footer">
                                <button class="get-brochure-btn"
                                    onclick="openBrochurePopup('brochures/uttaranchal_mba.pdf', 'MBA')">
                                    <span>Get Brochure</span> <i class="fa fa-download"></i>
                                </button>
                ...
                <div class="item">
                    <div class="amity-course-card">
                        ...
                        <div class="amity-course-body">
                            ...
                            <div class="amity-course-footer">
                                <button class="get-brochure-btn"
                                    onclick="openBrochurePopup('brochures/uttaranchal_mca.pdf', 'MCA')">
                                    <span>Get Brochure</span> <i class="fa fa-download"></i>
                                </button>
                                <span class="duration-info"><i class="fa fa-hourglass-half"></i> 24 Months</span>
                            </div>
    ...
    <section class="amity-approvals-section" id="approvals">
        <div class="container">
            <h2 class="approvals-main-heading text-center">Accreditation and Approvals of Uttaranchal University</h2>
            <div class="row mt-4">
    ...
    <section class="amity-steps-section">
        <div class="container">
            <h2>How to Apply for Online Degree Courses of Uttaranchal University</h2>
...
<section id="about-u360" class="about-u360-section">
        ...
        <div class="container">
            ...
            <div class="amity-accordion-wrapper">
                ...
                <div class="amity-accordion-item">
                    <h3 class="amity-accordion-heading">
                        <span>Q2. Does Uttaranchal University Online have any scholarships or EMI?</span>
                    </h3>
                    <div class="amity-accordion-content">
                ...
                <div class="amity-accordion-item">
                    <h3 class="amity-accordion-heading">
                        <span>Q3. What is the structure of Uttaranchal University Online MBA Fees for different
                            specialisations?</span>
                    </h3>
                    <div class="amity-accordion-content">
                        <p>Uttaranchal University Online MBA Fees depend on the specialisation preferred by the student.
                            In case
                ...
                <div class="amity-accordion-item">
                    <h3 class="amity-accordion-heading">
                        <span>Q6. How can an individual take the online admission at Uttaranchal University?</span>
                    </h3>
                    <div class="amity-accordion-content">
                        <p>Uttaranchal University online admission process is quite convenient. It includes completing
                            the
    ...
    <!-- UU Mobile Fixed Bottom Action Bar (Mobile View Only) -->
    <div class="amity-mobile-sticky-footer">
        <button type="button" class="amity-mobile-btn-brochure"
            onclick="openBrochurePopup('brochures/uttaranchal_main_brochure.pdf', '')">
            <span>Get Brochure</span> <i class="fa fa-download"></i>
        </button>
    ...
    <script>
        // Inject UU tracking values into all forms
        function setUUTrackingValues() {
            ...
            document.querySelectorAll('input[name="utm_medium"]').forEach(function (el) {
                if (!el.value) el.value = 'UU_Organic';
            });
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            window.openPopup = function () {
                ...
                setTimeout(setUUTrackingValues, 10);
            };
        });

        function initUUCarousel() {
            if (window.jQuery && jQuery.fn && jQuery.fn.owlCarousel) {
                ...
                setTimeout(initUUCarousel, 50);
            }
        }

        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', initUUCarousel);
        } else {
            initUUCarousel();
        }
