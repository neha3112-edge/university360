...
<body class="legal-page-body">
    ...
    <div class="legal-hero">
        <div class="hero-badge-pill">
            <i class="fa fa-university"></i> Educational Guidance Platform
        </div>
        <h1>About University360</h1>
        <p class="hero-subtitle">Your Trusted Guide to Online & Distance Higher Education</p>
            ...
            <div class="legal-card">
                ...
                <div class="mv-grid">
                    ...
                    <div class="mv-card vision-card">
                        ...
                        <p>To become India's most trusted education guidance platform for higher education. We aim to help every student achieve their academic and career goals with confidence.</p>
                    </div>
                </div>
                ...
                <div class="legal-section">
                    ...
                    <ul class="legal-list">
                        ...
                        <li><i class="fa fa-check-circle"></i> Admission Assistance</li>
                        <li><i class="fa fa-check-circle"></i> Fee Structure & Program Details</li>
                        <li><i class="fa fa-check-circle"></i> Personalized Course Recommendations</li>
                    </ul>
                </div>

                <div class="legal-section">
                    <h3><i class="fa fa-star"></i> Why University360?</h3>
                    <p>Finding the right course is about more than just admissions—it's about building a successful future. That's why thousands of students trust University360.</p>
                    ...
                    <div class="mv-grid" style="margin-top: 20px;">
                        ...
                        <div class="mv-card" style="border-top: 4px solid #0f385f;">
                            <h4 style="color: #0f385f; font-weight: 700; font-size: 16px; margin-bottom: 8px;"><i class="fa fa-shield" style="color: #ff6600; margin-right: 8px;"></i> Trusted University Information</h4>
                            <p style="font-size: 13.5px !important; margin: 0 !important;">We provide authentic, up-to-date information about recognized universities, helping students make informed decisions with confidence.</p>
                        </div>
                        ...
                        <div class="mv-card" style="border-top: 4px solid #0f385f;">
                            <h4 style="color: #0f385f; font-weight: 700; font-size: 16px; margin-bottom: 8px;"><i class="fa fa-heart" style="color: #ff6600; margin-right: 8px;"></i> Student-First Approach</h4>
                            <p style="font-size: 13.5px !important; margin: 0 !important;">From your first enquiry to choosing the right university, our team is committed to supporting you throughout your education journey.</p>
                        </div>
                    </div>
                </div>

                <!-- Why Students Trust Us Stats Grid -->
                <div style="background: #f0f5fa; border: 1px solid #cce0f0; border-radius: 14px; padding: 30px 24px; margin: 35px 0;">
                    <h3 style="color: #0f385f; font-size: 20px; font-weight: 700; text-align: center; margin-bottom: 24px;"><i class="fa fa-thumbs-up" style="color: #ff6600; margin-right: 8px;"></i> Why Students Trust Us</h3>
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px; text-align: center;">
                        <div style="background: #ffffff; padding: 18px 12px; border-radius: 10px; border: 1px solid #e2e8f0; box-shadow: 0 2px 8px rgba(0,0,0,0.03);">
                            <div style="color: #0f385f; font-size: 22px; font-weight: 800;"><i class="fa fa-check-circle" style="color: #10b981;"></i> 30,000+</div>
                            <div style="color: #475569; font-size: 13px; font-weight: 600; margin-top: 4px;">Students Guided</div>
                        </div>
                        <div style="background: #ffffff; padding: 18px 12px; border-radius: 10px; border: 1px solid #e2e8f0; box-shadow: 0 2px 8px rgba(0,0,0,0.03);">
                        ...
                        <div style="background: #ffffff; padding: 18px 12px; border-radius: 10px; border: 1px solid #e2e8f0; box-shadow: 0 2px 8px rgba(0,0,0,0.03);">
                            ...
                            <div style="color: #475569; font-size: 13px; font-weight: 600; margin-top: 4px;">Online Degree Programs</div>
                        </div>
                        <div style="background: #ffffff; padding: 18px 12px; border-radius: 10px; border: 1px solid #e2e8f0; box-shadow: 0 2px 8px rgba(0,0,0,0.03);">
                            <div style="color: #0f385f; font-size: 22px; font-weight: 800;"><i class="fa fa-check-circle" style="color: #10b981;"></i> 20+</div>
                            <div style="color: #475569; font-size: 13px; font-weight: 600; margin-top: 4px;">UGC-Approved Partners</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="goal-banner" style="flex-direction: column; gap: 8px; padding: 25px 20px;">
                    <div style="font-size: 18px; font-weight: 700; color: #ffffff;"><i class="fa fa-rocket" style="color: #ffcc00; margin-right: 8px;"></i> Start Your Journey with University360</div>
                    <p style="color: rgba(255,255,255,0.9) !important; font-size: 14px !important; margin: 0 !important;">Whether you're looking for an online degree, a distance education program, or expert guidance to choose the right university, University360 is here to support you every step of the way.</p>
                    <div style="color: #ffcc00; font-size: 14.5px; font-weight: 600; margin-top: 6px;">Your future deserves the right guidance. Let University360 help you take the next step with confidence.</div>
                </div>
