<?php
// ESGCI Landing Page - University360
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <meta name="description"
        content="ESGCI DBA Program Fees & Admissions Open 2026. Explore the DBA specialization and advance your career globally." />
    <meta name="keywords" content="ESGCI DBA, ESGCI DBA Program, Doctor of Business Administration Online">
    <link rel="canonical" href="https://university360.co/esgci.php">

    <!-- Open Graph & Social Meta Tags -->
    <meta property="og:title" content="ESGCI DBA Program Fees &amp; Admissions Open 2026" />
    <meta property="og:description"
        content="ESGCI DBA Programs 2026. Doctor of Business Administration with 9 specializations. Globally Recognized." />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://university360.co/esgci.php" />
    <meta property="og:image" content="https://university360.co/images/esgci-banner.png" />
    ...
    <script type="application/ld+json">
    {
      ...
      "name": "ESGCI",
      "url": "https://university360.co/esgci.php",
      "logo": "https://university360.co/images/esgci-logo.png",
      "slogan": "Where Business Meets Excellence",
      "description": "ESGCI offers globally recognized Doctor of Business Administration (DBA) programs with specializations across various management domains.",
      "address": {
        "@type": "PostalAddress",
...
<body>
                ...
                <div class="col-lg-5 col-md-12">
                    <div class="amity-banner-content-wrap">
                        <div class="d-none d-lg-block">
                            <img src="images/esgci-logo.png" alt="ESGCI" class="amity-banner-logo">
                        </div>
                        ...
                        <div class="d-none d-lg-block">
                            <button class="amity-download-brochure-btn"
                                onclick="openBrochurePopup('brochures/esgci_main_brochure.pdf', 'DBA General')">
                    ...
                    <div class="amity-mobile-center-visual">
                        <img src="images/esgci-logo.png" alt="ESGCI" class="amity-mobile-logo"><br>
                        <img src="images/new-mobile-v1.webp" alt="ESGCI Student" class="amity-mobile-student">
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="amity-why-item">
                                ...
                                <p>The ESGCI DBA is designed for working professionals, offering fully online
    ...
    <!-- <section class="amity-programmes-section" id="programmes">
        <div class="container">
            <h2>UNIVERSITY 360<br>DBA Programs at ESGCI</h2>
...
<section id="achievment">
            ...
            <div class="amity-accordion-wrapper">
                ...
                <div class="amity-accordion-item open">
                    <h3 class="amity-accordion-heading">
                        <span>Q1. How can UNIVERSITY 360 help with ESGCI DBA programs?</span>
                    </h3>
                    <div class="amity-accordion-content">
                        <p>UNIVERSITY 360 provides program information, counselling, course comparison, and admission
                            guidance for business professionals exploring ESGCI DBA programs.</p>
                    </div>
                </div>
                ...
                <div class="amity-accordion-item">
                    ...
                    <div class="amity-accordion-content">
                        <p>Yes. The ESGCI DBA program is specifically structured for working professionals, offering
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        ...
                        <p>Get 100% Free Counselling on ESGCI DBA Programs</p>
                    </div>
    ...
    <!-- ESGCI Mobile Fixed Bottom Action Bar (Mobile View Only) -->
    <div class="amity-mobile-sticky-footer">
        <button type="button" class="amity-mobile-btn-brochure"
            onclick="openBrochurePopup('brochures/esgci_main_brochure.pdf', '')">
            <span>Get Brochure</span> <i class="fa fa-download"></i>
        </button>
    ...
    <script>
        ...
        function initESGCICarousel() {
            if (window.jQuery && jQuery.fn && jQuery.fn.owlCarousel) {
                ...
                setTimeout(initESGCICarousel, 50);
            }
        }

        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', initESGCICarousel);
        } else {
            initESGCICarousel();
        }
