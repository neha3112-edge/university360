<?php
// Rushford Business School Landing Page - University360
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <meta name="description"
        content="Rushford Business School DBA Program Fees &amp; Admissions Open 2026. Doctor of Business Administration in General, International Business, Healthcare Management, HR, Supply Chain, Finance, Data Science, Marketing &amp; Business Analytics." />
    <meta name="keywords"
        content="Rushford Business School DBA, Rushford DBA Program, Doctor of Business Administration Online">
    <link rel="canonical" href="https://university360.co/rushford.php">

    <!-- Open Graph & Social Meta Tags -->
    <meta property="og:title" content="Rushford Business School DBA Program Fees &amp; Admissions Open 2026" />
    <meta property="og:description"
        content="Rushford Business School DBA Programs 2026. Doctor of Business Administration with 9 specializations. Globally Recognized." />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://university360.co/rushford.php" />
    <meta property="og:image" content="https://university360.co/images/rushford-banner.png" />
    ...
    <script type="application/ld+json">
    {
      ...
      "url": "https://university360.co/rushford.php",
      "logo": "https://university360.co/images/rushford-logo.png",
      "slogan": "Where Business Meets Excellence",
      "description": "Rushford Business School offers globally recognized Doctor of Business Administration (DBA) programs with specializations across various management domains.",
      "address": {
        "@type": "PostalAddress",
...
<body>
                ...
                <div class="col-lg-5 col-md-12">
                    <div class="amity-banner-content-wrap">
                        <div class="d-none d-lg-block">
                            <img src="images/rushford-logo.png" alt="Rushford Business School"
                                class="amity-banner-logo">
                        </div>

                        <h2 class="amity-sub-lead">Get Guidance From University360 for</h2>
                        <h1 class="amity-main-title">Rushford Business School</h1>
                        <p class="amity-slogan">Earn a Doctorate Title <br>along with Management Expertise</p>
                        ...
                        <div class="d-none d-lg-block">
                            <button class="amity-download-brochure-btn"
                                onclick="openBrochurePopup('brochures/rushford_main_brochure.pdf', 'DBA General')">
                    ...
                    <div class="amity-mobile-center-visual">
                        ...
                        <img src="images/new-mobile-v1.webp" alt="Rushford Business School Student"
    ...
    <section class="amity-programmes-section" id="programmes">
        <div class="container">
            <h2>DBA Programs at Rushford Business School</h2>
            ...
            <div class="owl-carousel amity-program-carousel">
                ...
                <div class="item">
                    <div class="amity-course-card">
                        ...
                        <img src="images/DBA General.webp" alt="DBA General" class="amity-course-img">
                ...
                <div class="item">
                    <div class="amity-course-card">
                        <span class="amity-course-badge">Doctorate</span>
                        <img src="images/DBA in International Business.webp" alt="DBA International Business"
                        ...
                        <div class="amity-course-body">
                            ...
                            <div class="amity-course-footer">
                                <button class="get-brochure-btn"
                                    onclick="openBrochurePopup('brochures/rushford_main_brochure.pdf', 'DBA in International Business')">
                                    <span>Get Brochure</span> <i class="fa fa-download"></i>
                                </button>
                                <span class="duration-info"><i class="fa fa-hourglass-half"></i> 36 Months</span>
                            </div>
                ...
                <div class="item">
                    <div class="amity-course-card">
                        <span class="amity-course-badge">Doctorate</span>
                        <img src="images/DBA in Healthcare Management.webp" alt="DBA Healthcare Management"
                            class="amity-course-img">
                        <div class="amity-course-body">
                            ...
                            <div class="amity-course-footer">
                                <button class="get-brochure-btn"
                                    onclick="openBrochurePopup('brochures/rushford_main_brochure.pdf', 'DBA in Healthcare Management')">
                                    <span>Get Brochure</span> <i class="fa fa-download"></i>
                                </button>
                                <span class="duration-info"><i class="fa fa-hourglass-half"></i> 36 Months</span>
                            </div>
                ...
                <div class="item">
                    <div class="amity-course-card">
                        <span class="amity-course-badge">Doctorate</span>
                        <img src="images/DBA in Human Resource Management.webp" alt="DBA HR Management"
                            class="amity-course-img">
                        <div class="amity-course-body">
                            ...
                            <div class="amity-course-footer">
                                <button class="get-brochure-btn"
                                    onclick="openBrochurePopup('brochures/rushford_main_brochure.pdf', 'DBA in Human Resource Management')">
                                    <span>Get Brochure</span> <i class="fa fa-download"></i>
                                </button>
                                <span class="duration-info"><i class="fa fa-hourglass-half"></i> 36 Months</span>
                            </div>
                ...
                <div class="item">
                    <div class="amity-course-card">
                        <span class="amity-course-badge">Doctorate</span>
                        <img src="images/DBA in Supply Chain Management.webp" alt="DBA Supply Chain Management"
                            class="amity-course-img">
                        <div class="amity-course-body">
                            ...
                            <div class="amity-course-footer">
                                <button class="get-brochure-btn"
                                    onclick="openBrochurePopup('brochures/rushford_main_brochure.pdf', 'DBA in Supply Chain Management')">
                                    <span>Get Brochure</span> <i class="fa fa-download"></i>
                                </button>
                                <span class="duration-info"><i class="fa fa-hourglass-half"></i> 36 Months</span>
                            </div>
                ...
                <div class="item">
                    <div class="amity-course-card">
                        <span class="amity-course-badge">Doctorate</span>
                        <img src="images/DBA in Finance.webp" alt="DBA Finance" class="amity-course-img">
                        <div class="amity-course-body">
                            ...
                            <div class="amity-course-footer">
                                <button class="get-brochure-btn"
                                    onclick="openBrochurePopup('brochures/rushford_main_brochure.pdf', 'DBA in Finance')">
                                    <span>Get Brochure</span> <i class="fa fa-download"></i>
                                </button>
                                <span class="duration-info"><i class="fa fa-hourglass-half"></i> 36 Months</span>
                            </div>
                ...
                <div class="item">
                    <div class="amity-course-card">
                        <span class="amity-course-badge">Doctorate</span>
                        <img src="images/DBA in Data Science.webp" alt="DBA Data Science" class="amity-course-img">
                        <div class="amity-course-body">
                            ...
                            <div class="amity-course-footer">
                                <button class="get-brochure-btn"
                                    onclick="openBrochurePopup('brochures/rushford_main_brochure.pdf', 'DBA in Data Science')">
                                    <span>Get Brochure</span> <i class="fa fa-download"></i>
                                </button>
                                <span class="duration-info"><i class="fa fa-hourglass-half"></i> 36 Months</span>
                            </div>
                ...
                <div class="item">
                    <div class="amity-course-card">
                        <span class="amity-course-badge">Doctorate</span>
                        <img src="images/DBA in Marketing.webp" alt="DBA Marketing" class="amity-course-img">
                        <div class="amity-course-body">
                            ...
                            <div class="amity-course-footer">
                                <button class="get-brochure-btn"
                                    onclick="openBrochurePopup('brochures/rushford_main_brochure.pdf', 'DBA in Marketing')">
                                    <span>Get Brochure</span> <i class="fa fa-download"></i>
                                </button>
                                <span class="duration-info"><i class="fa fa-hourglass-half"></i> 36 Months</span>
                            </div>
    ...
    <section class="amity-approvals-section" id="approvals">
        <div class="container">
            <h2 class="approvals-main-heading text-center">Accreditation and Approvals of Rushford Business School</h2>
            <div class="row mt-4">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="amity-approval-card">
                        <div class="approval-icon"><img src="images/approva-01-rusford.webp" alt="UGC Approved"></div>
                        <h4>5 Star QS Rating</h4>
                        <p>Rushford has received an overall 4 star rating in the world-renowned QS Star rating system,
                            earning 5 stars in online learning and teaching.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="amity-approval-card">
                        <div class="approval-icon"><img src="images/acbsp-rushford.webp" alt="UGC-DEB Recognized">
                        </div>
                        <h4>ACBSP Member</h4>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="amity-approval-card">
                        <div class="approval-icon"><img src="images/iacbe-rushford.webp" alt="Globally Accredited">
                        </div>
                        <h4>IACBE Educational</h4>
                        <p>IACBE ensures accountability among institutions by having them regularly assess and report on
                            the quality of their business education.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="amity-approval-card">
                        <div class="approval-icon"><img src="images/eduqua.webp" alt="AICTE Approved"></div>
                        <h4>EDUQUA Certified</h4>
                        <p>EduQua is Switzerland’s official and premier accreditation body for continuing education.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="amity-approval-card">
                        <div class="approval-icon"><img src="images/un_prime.webp" alt="NIRF Ranked"></div>
                        <h4>UN PRME Member</h4>
                        <p>UN PRME membership signifies that Rushford’s business education aligns with UN’s principles
                            for responsible management education.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="amity-approval-card">
                        ...
                        <h4>AACSB Member</h4>
                        <p>Global education and business leaders association dedicated to advancing quality business
                            education worldwide, demonstrating a commitment to educational excellence.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="amity-steps-section">
        <div class="container">
            <h2>How to Apply for a DBA Program at Rushford Business School</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="amity-why-item">
                                ...
                                <p>The Rushford DBA is designed for working professionals, offering fully online
    ...
    <section class="amity-faqs-section" id="faqs">
        <div class="container">
            ...
            <div class="amity-accordion-wrapper">
                ...
                <div class="amity-accordion-item">
                    <h3 class="amity-accordion-heading">
                        <span>Q3. What is the duration of the DBA program at Rushford Business School?</span>
                    </h3>
                    <div class="amity-accordion-content">
                        <p>The Rushford Business School DBA program is typically completed in 36 months (3 years).
                ...
                <div class="amity-accordion-item">
                    <h3 class="amity-accordion-heading">
                        <span>Q4. Is the DBA from Rushford Business School globally recognized?</span>
                    </h3>
                    <div class="amity-accordion-content">
                ...
                <div class="amity-accordion-item">
                    ...
                    <div class="amity-accordion-content">
                        <p>Yes. The Rushford DBA program is specifically structured for working professionals, offering
    ...
    <!-- Rushford Mobile Fixed Bottom Action Bar (Mobile View Only) -->
    <div class="amity-mobile-sticky-footer">
        <button type="button" class="amity-mobile-btn-brochure"
            onclick="openBrochurePopup('brochures/rushford_main_brochure.pdf', '')">
            <span>Get Brochure</span> <i class="fa fa-download"></i>
        </button>
    ...
    <script>
        // Inject Rushford tracking values into all forms
        function setRushfordTrackingValues() {
            document.querySelectorAll('input[name="sub_source"]').forEach(function (el) {
                el.value = 'Rushford_Organic';
            });
            document.querySelectorAll('input[name="utm_medium"]').forEach(function (el) {
                if (!el.value) el.value = 'Rushford_Organic';
            });
        ...
        document.addEventListener('DOMContentLoaded', function () {
            setRushfordTrackingValues();

            var _origOpenPopup = window.openPopup;
            window.openPopup = function () {
                if (_origOpenPopup) _origOpenPopup.apply(this, arguments);
                setTimeout(setRushfordTrackingValues, 10);
            };
        });

        function initRushfordCarousel() {
            if (window.jQuery && jQuery.fn && jQuery.fn.owlCarousel) {
                ...
                setTimeout(initRushfordCarousel, 50);
            }
        }

        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', initRushfordCarousel);
        } else {
            initRushfordCarousel();
        }
