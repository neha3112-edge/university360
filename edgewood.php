...
<body>
    ...
    <section class="amity-approvals-section" id="approvals">
        <div class="container">
            <h2 class="approvals-main-heading text-center">Accreditation and Approvals of EdgeWood Online University</h2>
            <div class="row mt-4">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="amity-approval-card">
                        ...
                        <p>EdgeWood Online University is internationally recognized, ensuring the DBA degree meets
                            global
...
<section id="achievment">
    ...
    <section class="amity-steps-section">
        <div class="container">
            <h2>How to Apply for a DBA Program at EdgeWood Online University</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="amity-why-item">
                                ...
                                <p>The Edgewood DBA is designed for working professionals, offering fully online
