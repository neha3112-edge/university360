...
<body>
    ...
    <section class="amity-programmes-section" id="programmes">
        <div class="container">
            <h2>Sikkim Manipal University Online Courses</h2>
    ...
    <section class="amity-approvals-section" id="approvals">
        <div class="container">
            <h2 class="approvals-main-heading text-center">Accreditation and Approvals of Sikkim Manipal University</h2>
            <div class="row mt-4">
    ...
    <section class="amity-steps-section">
        <div class="container">
            <h2>How to Apply for Online Degree Courses of Sikkim Manipal University</h2>
